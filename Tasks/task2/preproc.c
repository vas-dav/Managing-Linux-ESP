gcc -E main.c prompt.c random_data.c
# 1 "main.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
get_v_from_args (char *s)
{
  ...
  if (sscanf (s, "%d", &value) != 1)
    {
      printf ("ERROR: %s\n", "One of the arguments is not a digit");;
      exit (1);
    }
  return value;
}
...
fulfill_args (int args, char *argv[])
{
  ...
  switch (args)
    {
    case 1:
      t->min = get_int (messages[0]);
      t->max = get_int (messages[1]);
      t->amount = get_int (messages[2]);
      break;
    case 2:
...
# 13 "random_data.c" 3 4
 ((void) sizeof ((
# 13 "random_data.c"
 d->amount <= (d->max - d->min + 1)
# 13 "random_data.c" 3 4
...
# 13 "random_data.c"
 "d->amount <= (d->max - d->min + 1)"
# 13 "random_data.c" 3 4
 , "random_data.c", 13, __extension__ __PRETTY_FUNCTION__); }))
# 13 "random_data.c"
                                            ;
  
# 14 "random_data.c" 3 4
 ((void) sizeof ((
# 14 "random_data.c"
 d->amount > 0
# 14 "random_data.c" 3 4
...
# 14 "random_data.c"
 "d->amount > 0"
# 14 "random_data.c" 3 4
 , "random_data.c", 14, __extension__ __PRETTY_FUNCTION__); }))
# 14 "random_data.c"
                       ;
  
# 15 "random_data.c" 3 4
 ((void) sizeof ((
# 15 "random_data.c"
 d->max != d->min
# 15 "random_data.c" 3 4
...
# 15 "random_data.c"
 "d->max != d->min"
# 15 "random_data.c" 3 4
 , "random_data.c", 15, __extension__ __PRETTY_FUNCTION__); }))
# 15 "random_data.c"
                          ;
  
# 16 "random_data.c" 3 4
 ((void) sizeof ((
# 16 "random_data.c"
 d->max > d->min
# 16 "random_data.c" 3 4
...
# 16 "random_data.c"
 "d->max > d->min"
# 16 "random_data.c" 3 4
 , "random_data.c", 16, __extension__ __PRETTY_FUNCTION__); }))
# 16 "random_data.c"
                         ;
}
...
# 70 "cherry_leaks.h"
 extern void *(*s_m) (size_t);
  extern void *(*s_r) (void *, size_t);
  extern void *(*s_c) (size_t, size_t);
  extern void (*s_f) (void *);
...
# 176 "cherry_leaks.h"
  void block_value (c_mem_entity *block, void *addr, size_t s, char *fl,
                    size_t l, uint8_t allc_t);
...
# 210 "cherry_leaks.h"
  void *memory_data_malloc (size_t amount, const char *file, size_t line);
# 222 "cherry_leaks.h"
  void *memory_data_realloc (void *ptr, size_t amount, const char *file,
                             size_t line);
# 234 "cherry_leaks.h"
  void *memory_data_calloc (size_t amount, size_t size, const char *file,
                            size_t line);
  ...
  void memory_data_free (void *ptr, const char *file, size_t line);
# 256 "cherry_leaks.h"
  typedef struct Rame
  {
    void *data;
  ...
  __attribute__ ((unused)) Rame *grow_first_rame ();
  ...
  void grow_cherry_at_beginning (Rame **beginning, void *cherry,
                                 size_t cherry_size);
# 279 "cherry_leaks.h"
  __attribute__ ((unused)) void grow_cherry_after_cherry (Rame *cherry_on_rame,
                                                          void *cherry,
                                                          size_t cherry_size);
...
# 298 "cherry_leaks.h"
  __attribute__ ((unused)) Rame *find_rame (Rame **beginning,
                                            int (*cherry_callback) (void *));
# 308 "cherry_leaks.h"
  __attribute__ ((unused)) void pick_cherry (Rame *beginning, void *cherry);
